export const PORTFOLIO = [
  {
    ...
    testimonial:
      'Working with Benjamin was amazing. This project has survived since I met Benjamin. He really saved this project from its death. He was also very kind and cool. He knows exactly what I wanted and always suggested the best solutions to save the project. Highly recommend him!',
  },
  {
    id: 'LawnProSoftware',
    ...
    testimonial:
      'Fantastic! I have been working with Benjamin over the past 4 years and finally we reached to the goal!',
  },
  {
    id: 'Peymynt',
    ...
    testimonial:
      'Working with Benjamin has been a pleasure. Better yet - I alerted them a critical issues that was annoying me for years. Suprisingly the issue was fixed the next morning. I couldn`t ask for better support. Thank you Benjamin!',
  },
  // {
  //   id: 'satechi',
  ...
  //   testimonial:
  //     'Working with Benjamin Doe has been a pleasure. Better yet - I alerted them of a minor issue before going to sleep. The issue was fixed the next morning. I couldn`t ask for better support. Thank you Artur! This is easily a 5 star freelancer.',
  // },
  // {
  //   id: 'logitech',
